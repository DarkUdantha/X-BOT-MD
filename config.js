...
const SESSION_ID = process.env.SESSION_ID || "X-BOT-MD:AdvisingInvolved";
const SUDO = process.env.SUDO || '94741558775';
...
const HEROKU_APP_NAME = process.env.HEROKU_APP_NAME || "xbot";
